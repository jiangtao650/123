...
public class UserServiceImpl implements UserService {
    ...
    public JSONObject addUser(JSONObject jsonObject) {
        ...
        insert.put("userId", jsonObject.getLong("userId"));
        insert.put("deleteStatus", DeleteStateEnum.NORMAL.getCode());
        insert.put("createPerson", userInfo.get("userId"));
        insert.put("updatePerson", userInfo.get("userId"));
