<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="menu_code" prop="roleName" width="150"></el-table-column>
      <el-table-column align="center" label="menu_name" prop="roleName" width="150"></el-table-column>
